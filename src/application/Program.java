	...
	public static void main(String[] args) {
		...
		try {
			...
			case 1:
				...
				System.out.println("Enter the path where you want your database: ");
				sc.nextLine();
			...
			case 2:
				...
				System.out.println("Enter the file path of sequence you want compare in fasta format: ");
				...
				System.out.println("Enter the path for the result file: ");
				sc.nextLine();
